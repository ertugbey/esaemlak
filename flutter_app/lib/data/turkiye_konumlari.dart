// Auto-generated from turkiye-api-main
// provinces: 81, districts: 973

/// Türkçe locale-duyarlı karşılaştırıcı
/// Ş, İ, Ç, Ğ, Ö, Ü harflerini doğru sıralar
int turkishCompare(String a, String b) {
  ...
  for (int i = 0; i < minLen; i++) {
    ...
    // Tanınmayan karakter varsa unicode karşılaştır
...
class TurkiyeKonumlari {
  /// Tüm 81 il — A'dan Z'ye Türkçe sıralı
  static List<String> get iller {
    final list = List<String>.from(_illerConst);
    list.sort(turkishCompare);
    return list;
  }

  static const List<String> _illerConst = [
    'Adana',
    'Adıyaman',
    'Afyonkarahisar',
    'Ağrı',
  ...
  /// İlçe getir — Türkçe alfabetik sıralı kopya döndürür
